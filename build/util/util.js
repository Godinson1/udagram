...
exports.handleServerError = exports.validateImageUrl = exports.deleteLocalFiles = exports.filterImageFromURL = void 0;
...
function deleteLocalFiles(file) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
var validateImageUrl = function (imageUrl, res) {
    if (!imageUrl)
